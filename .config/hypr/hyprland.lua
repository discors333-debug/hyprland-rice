...
-- Open a kitty terminal running Claude Code
...
-- Wallpaper picker (rofi menu, switches wallpaper via awww)
hl.bind(mainMod .. " + R", hl.dsp.exec_cmd("~/.config/hypr/scripts/wallpaper-select.sh"))
...
-- >>> hyprland-infinite-desktop (keybindings) START
-- Workspaces
...
-- <<< hyprland-infinite-desktop (keybindings) END
